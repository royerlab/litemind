...
class MockCallback(BaseCallbacks):
    ...
    def on_text_generation(self, messages: List[str], response: str, **kwargs) -> None:
        ...
        self.call_parameters_dump = f'messages={messages}, response={response}, kwargs={kwargs},'
    ...
    def on_audio_transcription(self, audio_uri: str, transcription: str, **kwargs) -> None:
        ...
        self.call_parameters_dump = f'audio_uri={audio_uri}, transcription={transcription}, kwargs={kwargs},'
    ...
    def on_document_conversion(self, document_uri: str, markdown: str, **kwargs) -> None:
        ...
        self.call_parameters_dump = f'document_uri={document_uri}, markdown={markdown},'
    ...
    def on_video_conversion(self, video_uri: str, images: List[str], audio: str, **kwargs) -> None:
        ...
        self.call_parameters_dump = f'video_uri={video_uri}, images={images}, audio={audio},'
    ...
    def on_image_embedding(self, image_uris: List[str], embeddings: Sequence[Sequence[float]], **kwargs) -> None:
        ...
        self.call_parameters_dump = f'image_uris={image_uris}, embeddings={embeddings},'
    ...
    def on_audio_embedding(self, audio_uris: List[str], embeddings: Sequence[Sequence[float]], **kwargs) -> None:
        ...
        self.call_parameters_dump = f'audio_uris={audio_uris}, embeddings={embeddings},'
...
def test_audio_transcription(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    audio_transcription_model_name = api_instance.get_best_model(ModelFeatures.AudioTranscription)
...
def test_text_generation(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    text_generation_model_name = api_instance.get_best_model([ModelFeatures.TextGeneration])
    if text_generation_model_name:
        messages = [
            Message(role="system", text="You are an omniscient all-knowing being called Ohmm"),
...
def test_audio_generation(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    audio_generation_model_name = api_instance.get_best_model(ModelFeatures.AudioGeneration)
...
def test_image_generation(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    image_generation_model_name = api_instance.get_best_model(ModelFeatures.ImageGeneration)
...
def test_text_embedding(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    text_embedding_model_name = api_instance.get_best_model(ModelFeatures.TextEmbeddings)
    if text_embedding_model_name:
        api_instance.embed_texts(texts=['Cat', 'Dog'], model_name=text_embedding_model_name)
...
def test_image_embedding(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    image_embedding_model_name = api_instance.get_best_model(ModelFeatures.ImageEmbeddings)
    if image_embedding_model_name:
        ...
        api_instance.embed_images(image_uris=[image_1_uri, image_2_uri], model_name=image_embedding_model_name)
...
def test_audio_embedding(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    audio_embedding_model_name = api_instance.get_best_model(ModelFeatures.AudioEmbeddings)
    if audio_embedding_model_name:
        ...
        api_instance.embed_audios(audio_uris=[audio_1_uri, audio_2_uri], model_name=audio_embedding_model_name)
...
def test_video_embedding(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    video_embedding_model_name = api_instance.get_best_model(ModelFeatures.VideoEmbeddings)
    if video_embedding_model_name:
        ...
        api_instance.embed_videos(video_uris=[video_1_uri, video_2_uri], model_name=video_embedding_model_name)
...
def test_image_description(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    image_description_model_name = api_instance.get_best_model([ModelFeatures.TextGeneration, ModelFeatures.Image])
...
def test_audio_description(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    audio_description_model_name = api_instance.get_best_model([ModelFeatures.TextGeneration, ModelFeatures.Audio])
...
def test_video_description(api_class):
    ...
    api_instance: BaseApi = api_class(callback_manager=callback_manager)
    callback_manager.add_callback(mock_callback)
    video_description_model_name = api_instance.get_best_model([ModelFeatures.TextGeneration, ModelFeatures.Video])
